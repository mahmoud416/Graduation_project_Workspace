...
from app.routes import auth, teams, memberships, tasks, projects, users, task_boards, ws, notifications, upload_rules, events, it, my_teams
...
app.include_router(my_teams.router, prefix="/api/v1")
